...
const App: React.FC = () => {
  ...
  return (
    <main className="nexus-shell w-full h-screen overflow-y-auto overflow-x-hidden bg-[#070B19] text-white">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#00F0FF] opacity-[0.025] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#D4AF37] opacity-[0.025] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 min-h-screen w-full flex flex-col gap-3 p-3">
        <header className="glass-panel shrink-0 flex min-h-14 items-center justify-between gap-4 px-4 py-3">
          <div className="flex min-w-0 items-center gap-4">
            <div className="flex shrink-0 items-center gap-2">
              <div className="w-3 h-3 border-2 border-[#00F0FF] rounded-sm rotate-45 animate-pulse-shield" />
              <h1 className="text-sm font-bold font-[Orbitron] tracking-wider text-[#00F0FF] neon-cyan whitespace-nowrap">
                NEXUS STRESS-HUD
              </h1>
            </div>
            <span className="hidden lg:block truncate border-l border-gray-700 pl-4 text-[9px] text-gray-500">
          ...
          <div className="flex shrink-0 items-center gap-4 sm:gap-6">
            ...
            <div className="text-xs font-mono text-[#D4AF37] neon-gold">{formatTime(currentTime)}</div>
          </div>
        </header>
        ...
        <section className="shrink-0 min-h-[190px] h-[220px]">
